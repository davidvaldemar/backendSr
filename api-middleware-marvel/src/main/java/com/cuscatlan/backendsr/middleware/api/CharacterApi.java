...
public class CharacterApi {
	 ...
	 */
	@GetMapping("")
	public ResponseEntity<String> getCharacterByName(@RequestParam(name = "name") String name, 
		...
		try {
			...
			result = marvelBusiness.getCharacterByName(name, nameStartsWith, comics, series, uuid);
		}catch(Exception e) {
